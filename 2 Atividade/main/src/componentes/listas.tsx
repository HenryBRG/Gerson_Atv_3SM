...
export default class Listas extends Component<props, State> {
    ...
    // Retorna os 5 principais clientes por total gasto
    ...
    // Retorna os itens mais comprados por raça de pet
    ...
    // Retorna os 10 principais clientes por número de compras
    ...
    // Retorna os 5 itens mais comprados em geral
    ...
    // Retorna os itens mais comprados por tipo de pet
    ...
    {showTopRacaPorPet && (
        <div style={{ marginTop: "20px", backgroundColor:'white', color:'black', borderRadius:'20px' }}>
            <div style={{padding:'30px'}}>
            <h2>Itens Mais Consumidos por Raça de Pet</h2>
    ...
    {/* Lista de Top Clientes que Mais Gastaram */}
    {showTopClientesPorValor && (
        <div style={{ marginTop: "20px", backgroundColor:'white', color:'black', borderRadius:'20px' }}>
            <div style={{padding:'30px'}}>
            <h2>Top 5 Clientes que Mais Gastaram</h2>
            <ul style={{ listStyleType: "none", padding: 0 }}>
    ...
    {/* Lista de Top 10 Clientes que Mais Consumiram */}
    {showTopClientes && (
        <div style={{ marginTop: "20px", backgroundColor:'white', color:'black', borderRadius:'20px' }}>
            <div style={{padding:'30px'}}>
            <h2>Top 10 Clientes que Mais Consumiram</h2>
            <ul style={{ listStyleType: "none", padding: 0 }}>
    ...
    {/* Lista de Top Itens Mais Consumidos */}
    {showTopItens && (
            <div style={{ marginTop: "20px", backgroundColor:'white', color:'black', borderRadius:'20px' }}>
            <div style={{padding:'30px'}}>
            <h2>Top 5 Itens Mais Consumidos</h2>
            <ul style={{ listStyleType: "none", padding: 0 }}>
    ...
    {/* Lista de Itens Mais Consumidos por Tipo de Pet */}
    {showTopItensPorPet && (
        <div style={{ marginTop: "20px", backgroundColor:'white', color:'black', borderRadius:'20px' }}>
            <div style={{padding:'30px'}}>
            <h2>Itens Mais Consumidos por Tipo de Pet</h2>
